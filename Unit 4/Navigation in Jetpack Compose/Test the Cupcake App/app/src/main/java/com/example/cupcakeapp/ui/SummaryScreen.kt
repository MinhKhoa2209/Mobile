...
import com.example.cupcakeapp.data.OrderData
...
fun OrderSummaryScreen(
    ...
    val items = listOf(
        ...
        Pair(stringResource(R.string.flavor), orderData.flavor),
        // Summary line 3: display selected pickup date
        Pair(stringResource(R.string.pickup_date), orderData.date)
    )
...
fun OrderSummaryPreview() {
    CupcakeAppTheme  {
        OrderSummaryScreen(
            orderData = OrderData(0, "Test", "Test", "$300.00"),
