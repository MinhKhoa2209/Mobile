...
fun CheckoutScreen(
    ...
    Column(
        ...
        ItemSummary(item = order.entree, modifier = Modifier.fillMaxWidth())
        ItemSummary(item = order.sideDish, modifier = Modifier.fillMaxWidth())
        ItemSummary(item = order.accompaniment, modifier = Modifier.fillMaxWidth())
        ...
        OrderSubCost(
            ...
            price = order.itemTotalPrice.formatPrice(),
            Modifier.align(Alignment.End)
        )

        OrderSubCost(
            resourceId = R.string.tax,
            price = order.orderTax.formatPrice(),
            Modifier.align(Alignment.End)
        )

        Text(
            text = stringResource(R.string.total, order.orderTotalPrice.formatPrice()),
